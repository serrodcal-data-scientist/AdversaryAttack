...
una red neuronal construida utilizando Keras/Tensorwlow.
...
un coche. Para ello, primero importamos las librerías que necesitamos.
...
\end{Verbatim}
    ...
    Finalmente, vamos a utilizar la imagen para probar nuestro modelo, en
este caso, será la imagen de un coche.
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} Cargamos la imagen en una variable como array con un tamaño redimensionado a 299x299}
        \PY{n}{X} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{img\PYZus{}to\PYZus{}array}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{load\PYZus{}img}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./coche.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{target\PYZus{}size}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{299}\PY{p}{,}\PY{l+m+mi}{299}\PY{p}{)}\PY{p}{)}\PY{p}{)} 
...
\end{Verbatim}
    ...
    La red neuronal nos pide que pasemos un formato especial, un tensor, que
tiene unas dimensiones parecidas a las que tenemos ahora, pero
necesitamos una dimensión más:
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} [[('n04285008', 'sports\_car', 0.76075476),
          ('n03459775', 'grille', 0.079246424),
          ('n03100240', 'convertible', 0.046836168),
          ('n04037443', 'racer', 0.0211682),
          ('n02974003', 'car\_wheel', 0.01438693)]]
\end{Verbatim}
            
    La imagen que le hemos pasado es la siguiente, que nos ha dicho que es
un coche deportivo:
...
Ahora vamos a generar la nueva imagen, la que provocará que la red
...
\end{Verbatim}
    ...
    Ahora vamos a realizar el gradiente, para encontrar el mínimo, es decir,
el objetivo:
...
\end{Verbatim}
    ...
    Finalmente, vamos a devolver al rango de intesidades la nueva imagen y a
mostrarla.
...
\end{Verbatim}
    ...
    Ahora vemos la imagen hackeada, y se ven ciertos pixeles que nos pueden
hacer sospechar. Además, vamos a guardar dicha imagen para que se
persistan.
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Guardamos la imagen}
         ...
         \PY{n}{im}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./coche\PYZus{}hacked.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Cargamos la imagen en una variable como array con un tamaño redimensionado a 299x299}
         \PY{n}{img\PYZus{}hacked} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{img\PYZus{}to\PYZus{}array}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{load\PYZus{}img}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./coche\PYZus{}hacked.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{target\PYZus{}size}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{299}\PY{p}{,}\PY{l+m+mi}{299}\PY{p}{)}\PY{p}{)}\PY{p}{)} 
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}16}]:} [[('n03459775', 'grille', 0.44975972),
           ('n04285008', 'sports\_car', 0.32452583),
           ('n04037443', 'racer', 0.085936964),
           ('n02974003', 'car\_wheel', 0.042665422),
           ('n03100240', 'convertible', 0.011454979)]]
\end{Verbatim}
...
Ahora vamos a decirle a la red neuronal que no se extralimite haciendo
la manipulación, así la imagen pasará por una imagen normal.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{adv} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{img\PYZus{}hacked}\PY{p}{)}
...
\end{Verbatim}
    ...
    Vamos a mostrar el resultado, para ver que la imagen parece que no ha
sido alterada:
...
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{im} \PY{o}{=} \PY{n}{Image}\PY{o}{.}\PY{n}{fromarray}\PY{p}{(}\PY{n}{adv}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{uint8}\PY{p}{)}\PY{p}{)}
         \PY{n}{im}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./coche\PYZus{}hacked\PYZus{}good.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Cargamos la imagen en una variable como array con un tamaño redimensionado a 299x299}
         \PY{n}{img\PYZus{}hacked} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{img\PYZus{}to\PYZus{}array}\PY{p}{(}\PY{n}{image}\PY{o}{.}\PY{n}{load\PYZus{}img}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./coche\PYZus{}hacked\PYZus{}good.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{target\PYZus{}size}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{299}\PY{p}{,}\PY{l+m+mi}{299}\PY{p}{)}\PY{p}{)}\PY{p}{)} 
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} [[('n07749582', 'lemon', 0.99824047),
           ('n07747607', 'orange', 0.00090086751),
           ('n02974003', 'car\_wheel', 6.3390318e-05),
           ('n03459775', 'grille', 4.1884861e-05),
           ('n03100240', 'convertible', 3.9411218e-05)]]
\end{Verbatim}
